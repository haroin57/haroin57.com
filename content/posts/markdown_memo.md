...
1. 画像を `public/posts/` フォルダに配置
2. MDファイルでは `/posts/画像ファイル名` で参照

````md
![写真の説明](/posts/example.jpg)
````

> [!NOTE]
> 画像ファイル名は半角英数字とハイフン・アンダースコアのみ推奨

**推奨フォーマット:**
- 写真: `.webp` または `.jpg`（WebP推奨）
- 図やスクリーンショット: `.png` または `.webp`

**外部画像（R2など）:**

````md
![写真の説明](https://images.haroin57.com/xxxxx.png)
````
